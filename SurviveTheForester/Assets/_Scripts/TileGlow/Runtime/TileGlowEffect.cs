...
{
    /// <summary>
    /// Adds an HDR outline over the <see cref="TilemapRenderer"/>'s sprite borders.
    /// Can be used in conjuction with bloom post-processing to create a glow effect.
    /// </summary>
    [AddComponentMenu("Effects/Tile Glow")]
    [RequireComponent(typeof(TilemapRenderer)), DisallowMultipleComponent, ExecuteInEditMode]
    public class TileGlowEffect : MonoBehaviour
    {
        ...
        private void SetMaterialProperties ()
        {
            ...
            Renderer.sharedMaterial = TileGlowMaterial.GetSharedFor(this);
